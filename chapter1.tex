...
Notion de VANET et applications
...
• Système d’alerte d’urgence pour les véhicules.• Contrôle coopératif de la vitesse de croisière des véhicules.• Alerte aux collisions.• Évitement des collisions d’intersection.• Avertissement d’approche des véhicules d’urgence (Blue Waves).• Inspection de sécurité des véhicules.• Transi ou de priorité de signal de véhicule d’urgence.• Dédouanement et inspections de sécurité des véhicules commerciaux• Signature en – véhicule.• Avertissement en cas de retournement.• Sonde de collecte de données (OBD).• Avertissement d’intersection route – rail.• Paiements électroniques de stationnement (Télépéage) [6].

Les Communications dédiées à courte portée (DSRC)

Le concept de base de DSRC
...
Les couches de protocoles utilisés dans la communication DSRC
...
\hlineFlow des évènements &  &  &  &  &  \\
\hline1.  Le véhicule “A” emis MSG\_BasicSafetyMessageFrame, Part I &  &  &  &  &  \\
\hline2.  Le véhicule « B » recevoir le message &  &  &  &  &  \\
\hline3.  Le véhicule « B » reconnait que le message du véhicule A est pertinent (rubrique similaire à l’avance de la trajectoire du véhicule B) et un évènement de freinage important est en cours par les informations du message (par exemple, de décélération, la pression de freinage). &  &  &  &  &  \\
\hline4.  Le véhicule « B » alerte son pilote à l’évènement de freinage et fournit une indication de la gravité de freinage. &  &  &  &  &  \\
\hlineÉquipements Matériels : & DSRC radio Capteurs de position Interface Homme-Machine &  &  &  &  \\
\hlineActeurs : (qu’elles sont les entités joue un rôle actif dans l’utilisation ?) & Systèmes Véhicule & Occupant & Fournisseur de Service & Département de la route &  \\
...
\centering
\begin{tabular}{|c|}
\hlineNom d’élément    Valeur simple       Longueur en Octet Valeur en Hexa Commentaires \\
\hlinemsgID                          2                               1                        0x02  blob1                                                            38  msgCnt                1                                       1                         0x01                 Arbitraire secMark               60 000                              2                     0xEA, 60              Arbitraire  id                         32,33,34,35                     4                0x20, 21, 22, 23         Arbitraire lat                         35 deg north                    4                    10B07600              1/8th micro deg long                      120 deg west                   4                    39 387 000            1/8th micro deg elev                      1000 meters                    2                       2710 accuracy               Perfect Accuracy            4                00, 00 , 00 , 00 speed                    50.00 m/s                       2                        1388             dans 0.01 ms, conduite  heading                Due south                      2                         4000  angle                    Ahead                            1                          \_\_\_ accelSet                None                              7                     0000, 0000,00,0000 None, and no yaw  brakes                  All on/Active                   2                                FF, F0        trac/abs/scs present  size (with)             220 cm                   3(1/2 of 3)                          0DC                environ 6 ft  size (length)          670 cm                    3(1/2 of 3)                          29E                environ 22 ft \\
\hline\end{tabular}
\caption{Table extracted}
\end{table}
BasicSafetyMessage : : = \{
...
\begin{tabular}{|c|}
\hlineNom d’élément    Valeur simple       Longueur en Octet Valeur en Hexa Commentaires \\
\hlinemsgID                          2                               1                        0x02  blob1                                                            38    msgCnt                    \_                               1                                              Arbitraire   secMark                   \_                               2                                              Arbitraire id                             \_\_                               4               0x20, 21, 22, 23       Arbitraire lat                      90 deg north                     4                    2AEA5400         1/8th micro deg long                   180 deg west                    4                    55D4A800         1/8th micro deg elev                   6143.9 meters                  2                       EFFF accuracy        Worst Accuracy                   4                7F, 7F, 7 F, FF speed                 327.67 m/s                      2                       7FFF      dans 0.01 ms, conduite heading               Due south                      2                        4000 angle                         00                            1                          \_\_\_ accelSet               Extreme                        7           07D0,07D0,7 F,7FFD None, and no yaw brakes               All on/Active                    2                        FF, F0         trac/abs/scs present size (with)              1023 cm                3(1/2 of 3)               3 FF                 environ 6 ft size (length)          4095 cm                 3(1/2 of 3)               FFF                 environ 22 ft \\
\hline\end{tabular}
\caption{Table extracted}
\end{table}
