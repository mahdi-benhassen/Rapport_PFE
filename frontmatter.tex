\begin{titlepage}
    ...
    {\Large \textbf{Mémoire de Projet de Fin d’Études}}\\[0.5cm]
    
    Présenté en vue de l’obtention du\\[0.5cm]
    
    {\Large \textbf{Diplôme National d’Ingénieur en Sciences Appliquées et Technologie}}\\[0.5cm]
    
    \textbf{Spécialité :} Électronique : Microélectronique
    
    \vspace{2cm}
    
    Réalisé par\\[0.5cm]
    {\Large \textbf{Ben Hassen Mahdi}}
    
    \vspace{1.5cm}
    
    {\LARGE \textbf{Implémentation de l’algorithme de hachage sécurisé pour VANET sur FPGA}}
    ...
    \begin{tabular}{ll}
        \textbf{Président :} & Mr. BOUBAKER Mohamed \\
        \textbf{Membre :} & Mr. DOUSS Skander \\
        \textbf{Encadrant :} & Mr. BEN DHAOU Imed \\
    \end{tabular}
...
\textbf{Mots-clés :} VANET, DSRC, SAE 2735, IEEE 1609.2, ECDSA, SHA-2, Implémentation hardware de SHA-256, FPGA, DSP, Synthèse haut-niveau.
...
\textbf{Keywords:} VANET, DSRC, SAE 2735, IEEE 1609.2, ECDSA, SHA-256, Hardware implementation of SHA-256, FPGA, DSP, High-Level-Synthesis.
...
\begin{description}[style=multiline, leftmargin=3cm, font=\bfseries]
    ...
    \item[BER] Basic Encoding Rules (règles d’encodage basique)
    ...
    \item[MANET] Metropolitan Ad Hoc Networks
    \item[OBE] On-board equipment (DSRC equipment connected directly to a vehicle databus)
    \item[OSI] Open Systems Interconnection
    \item[OBD] On Board Diagnostic
    \item[PDU] protocol data unit
    \item[RSE] RoadSide Equipment
    ...
    \item[VANETs] Vehicular Ad Hoc Networks
